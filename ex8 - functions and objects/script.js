...
var questionOne = new Question("Are you a good programmer?", ['0: Yes', '1: No'], 0);
var questionTwo = new Question("Do you like Javascript?", ['0: Yes', '1: No'], 0);
var questionThree = new Question("Does this program use any Closures?", ['0: Yes', '1: No'], 1);

var questions = [questionOne, questionTwo, questionThree];

function play(){
    var random = Math.floor(Math.random() * 3);
    questions[random].logQuestion();
    questions[random].getAnswer(); //still the same 'random'
}
